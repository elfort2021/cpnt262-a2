...
export const image =[ 
  ...
  },
  {
    ...
    description: 'These tropical perennials are grown for their ornamental foliage. They are mostly natives of tropical America.',
    width: 683,
  ...
  },
  {
    id: 04, 
    title: 'Monstera',
    description: 'The genus is named from the Latin word for "monstrous" or "abnormal", and refers to the unusual leaves with natural holes that members of the genus have.',
    width: 683, 
  ...
  },
  {
    id: 05, 
    title: 'Helianthus',
    description: 'The common names "sunflower" and "common sunflower" typically refer to the popular annual species Helianthus annuus, whose round flower heads in combination with the ligules look like the sun.',
    width: 1024, 
    pathURL: 'images/img5.jpg',
    linkURL: 'https://en.wikipedia.org/wiki/Helianthus',
  ...
  },
  {
    id: 08, 
    title: 'Fern',
    description: 'A fern (Polypodiopsida or Polypodiophyta /ˌpɒliˌpɒdiˈɒfɪtə, -oʊfaɪtə/) is a member of a group of vascular plants (plants with xylem and phloem) that reproduce via spores and have neither seeds nor flowers. ',
    width: 683,
  ...
  },
  {
    id: 09, 
    title: 'Rubber Tree',
    description: 'Ficus elastica, the rubber fig, rubber bush, rubber tree, rubber plant, or Indian rubber bush, Indian rubber tree, is a species of plant in the fig genus, native to eastern parts of South Asia and southeast Asia.',
    width: 683, 
